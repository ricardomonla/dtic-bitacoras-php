...
<head>
    ...
    <title>Estado del Proyecto DTIC Bitácoras</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="estadoproyecto.html">
                            <i class="fas fa-info-circle me-1"></i>Estado del Proyecto
                        </a>
                    </li>
                </ul>
                ...
                <div class="col-12 text-center">
                    ...
                    <p class="mb-0">
                        <small class="text-light">
                            Proyecto desarrollado en etapas | Etapa actual: 2 de 5 |
                            <i class="fas fa-code me-1"></i>HTML/CSS/JS/PHP/MySQL
                        </small>
                    </p>
                </div>
            </div>
